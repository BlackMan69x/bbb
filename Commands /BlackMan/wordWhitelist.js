...
module.exports = {
  ...
  run: async (bot, message, args, dev) => {
    if (message.author.id === "937063235612450827") {
      let data = await Owner.findOne({ ownerCode: "937063235612450827" });
      if(!data) { Owner.create({ ownerCode: "937063235612450827" });} 
      /*
      worldWhitelist
      */
