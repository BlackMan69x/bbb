...
module.exports = {
  ...
  usage: ["p!antichannel [number/on/off]"],
  category: ["Security"],
  enabled: true,
   ...
   let guild = await Guild.findOne({ guildID: message.guild.id });
    ...
    if (args[1] === "on") {
      ...
      const embed = new Discord.MessageEmbed()
        .setColor(Color)
        .setDescription(`🟢 The **AntiChannel** system is enabled correctly!`);
      ...
      const embed1 = new Discord.MessageEmbed()
        .setColor(Color)
        .setDescription(`🔴 The **AntiChannel** system is disabled correctly!`);
